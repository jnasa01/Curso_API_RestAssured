package br.com.jairo.rest.tests;
...
public class BarrigaTest extends BaseTest {
    ...
    //@Before // executa antes de cada teste da Classe
    ...
    public void t07_naoDeveInserirMovimentacaoDataFutura() {
        ...
        Movimentacao mov = getMovimentacaoValida();
        mov.setData_transacao(DataUtils.getDataDiferencaDias(7));
    ...
    @Test
    public void t09_deveVerificarSaldodaConta() {
        ...
        given()
                ...
                .then()
                    .statusCode(200)
                    .body("find{it.conta_id == "+CONTA_ID+"}.saldo", is("153.00"))
    ...
    @Test
    public void t10_deverRemoverMovimentacao() {
